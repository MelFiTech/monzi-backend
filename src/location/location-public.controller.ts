...
export class LocationPublicController {
  ...
  @ApiOperation({
    ...
    description:
      'Get exact location match and business payment details (account number, bank name, account name) based on GPS coordinates. No authentication required. Suggests payment details of businesses that other users have paid to at this location.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Get nearby locations with business payment details (account numbers, bank names, account names) sorted by distance and confidence. No authentication required. Suggests payment details of businesses that other users have paid to at nearby locations.',
  })
  @ApiResponse({
    status: 200,
