...
export class AccountsService {
  ...
  async resolveAccount(
    ...
    try {
      ...
      console.log(
        '🌐 [UNIFIED PROVIDER] Using active transfer provider for account verification...',
      );

      // Use active transfer provider for account verification
      ...
      console.log(
        '✅ [TRANSFER PROVIDER] Final result:',
